...
{
       0,    30,    30,    32,    34,    35,    36,    38,    39,    41,
      42,    44,    46,    47,    49,    57,    58,    59,    60,    61,
      62,    63,    64,    66,    72,    74,    74,    90,    90,   101,
     104,   105,   107,   114,   114
};
#endif
...
#line 1206 "abst.tab.c"
    break;

  case 15: /* EXPR: EXPR '+' EXPR  */
#line 57 "abst.y"
                    {AddQuadruple("+",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1212 "abst.tab.c"
    break;

  case 16: /* EXPR: EXPR '-' EXPR  */
#line 58 "abst.y"
                {AddQuadruple("-",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1218 "abst.tab.c"
    break;

  case 17: /* EXPR: EXPR '*' EXPR  */
#line 59 "abst.y"
                {AddQuadruple("*",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1224 "abst.tab.c"
    break;

  case 18: /* EXPR: EXPR '/' EXPR  */
#line 60 "abst.y"
                {AddQuadruple("/",(yyvsp[-2].var),(yyvsp[0].var),(yyval.var));}
#line 1230 "abst.tab.c"
    break;

  case 19: /* EXPR: '-' EXPR  */
#line 61 "abst.y"
           {AddQuadruple("UMIN",(yyvsp[0].var),"",(yyval.var));}
#line 1236 "abst.tab.c"
    break;

  case 20: /* EXPR: '(' EXPR ')'  */
#line 62 "abst.y"
               {strcpy((yyval.var),(yyvsp[-1].var));}
#line 1242 "abst.tab.c"
    break;
...
#line 1345 "abst.tab.c"
    break;


#line 1349 "abst.tab.c"
